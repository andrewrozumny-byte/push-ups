...
- **Saturday**: ранковий крон — лише привітання суботи (без мему й кнопок); денний і вечірній крони не шлють повідомлення; на профілі кнопка відмітки вимкнена.
- **Friday after sunset**: **`/api/cron/friday-sunset`** — вечірній підсумок дня (як 22:00), без тижневої статистики й без кнопок.
- **Saturday after sunset**: **`/api/cron/saturday-sunset`** — підсумок тижня (нд–пт, макс. 6 днів) + персональні фрази, без кнопок.
